...
<p>■ID■</p>
ID<input type="text" nmae="MEMBER_ID">
<p>■名前</p>
姓<input type="text" name="LAST_NAME" >
名<input type="text" name="FARST_NAME" ><br>
<p>■性別</p>
<input type="radio" id="男" name="SEX" value="男"  checked>男
<input type="radio" id="女" name="SEX" value="女" >女<br>
<p>■生年月日</p>
