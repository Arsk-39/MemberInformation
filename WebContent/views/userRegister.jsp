...
名<input type="text" name="FARST_NAME" required><br>
<p>■性別</p>
...
<p>■電話番号</p>
<input type="tel" name="PHONE_NUMBER" size="12" maxlength="12" required><br>
<p>■メールアドレス</p>
<input type="text" name="MAIL_ADDRESS" size="30" maxlength="30" required>
<p>■仕事</p>
